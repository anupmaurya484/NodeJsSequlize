...
import './CalendarActions.css';
import jsonLogic from 'json-logic-js';

class CalendarActions extends Component {
    constructor(props) {
        super(props);
        this.state = {
            value: 0,
            ...
            eventsConfig: [
                ...
                {
                    "id": 1,
                    "eventName": "event updated to calendar",
                    //"actions": [{"name":"first action name"}]
                    "actions": [],
                    "conditions": {}
                }
    ...
    componentUpdate(props) {
        const { user, eventsConfig } = props;
        this.setState({
            user_data: user.user_data,
            eventsConfig: eventsConfig ? eventsConfig : this.state.eventsConfig
        });
    }
                ...
                <Row around>
                    ...
                    <Col md='4'>
                        ...
                        <h4>Example:</h4>
                            ...
                            <TabContent className="myClass" activeKey={this.state.activeTab} onSelect={this.handleSelect}>
