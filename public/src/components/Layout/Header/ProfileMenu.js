        ...
        <React.Fragment>
            <Dropdown isOpen={menu} toggle={() => setMenu(!menu)} className="d-inline-block">
                ...
                <DropdownMenu right className='login-dropdown'>
                    ...
                    {(!checkTenatLogin() && User_data.level != 6) && <Link to="/home/tenantrequest?request=new" className="header-profile"> <DropdownItem><FormattedMessage id="profile.menu.reqTenant" /></DropdownItem></Link>}
