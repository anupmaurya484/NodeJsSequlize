		...
		<div className="array-field-container">
			...
			}
			{
				props.items.map((element, idx1) => {
					...
					return (
						<Row key={idx1} className='zero-margin'>
							<Col md="10">
								{element.children}
							</Col>
							<Col md="2" className='m-auto'>
								<div className="btn-group">
									{element.hasMoveDown && (
										<span
											className="waves-effect waves-light btn btn-action-array-field p-2"
			...
			<Row className="total-amount-container">
				{
					props.schema.showTotalCell &&
					<Col md="11">
						<span className="col s3 left text-right">Sum column :</span>
